        ...
        fluidRow(
          tabBox(side="left",width = 12, title = "SPC - statystyczna obserwacja procesu", selected = "Karta ImR", 
            ...
            tabPanel(title = "Karta ImR", br(),
              fluidRow(
                column(width=12,
                  textOutput("hover_info.data"),
                  textOutput("hover_info.pomiar"),
                  plotOutput('kartaI', height = 300, click =clickOpts("plot_click", clip=FALSE),hover = hoverOpts(id = "plot_hover", delayType = "throttle", clip = TRUE, nullOutside = TRUE)),
